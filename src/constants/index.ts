...
export const DAO_FACTORY_ADDRESS: { [chainId in ChainId]?: string } = {
  ...
  [ChainId.ZetaChain_TESTNET]:
    process.env.REACT_APP_ZETA_TESTNET_DAO_FACTORY_ADDRESS || '0x626f936D28D758c9566d3EBC3A79491C23EB1015',
...
export const AIRDROP_ADDRESS: { [chainId in ChainId]?: string } = {
  ...
  [ChainId.ZetaChain_TESTNET]:
    process.env.REACT_APP_ZETA_TESTNET_AIRDROP_ADDRESS || '0xA7eFe998463f65A49080c848510698158C64500d',
